// commit pack commclt.h: 数据传输中包的头文件
//
//////////////////////////////////////////////////////////////////////
...
*/
	...
	TCHAR			strstatus[MAX_STATUS_LEN];	//40 状态
...
public:
	...
	TCHAR			strid[MAX_SID_LEN];	//60 字符串登陆
	TCHAR			pwd[MAX_PASSWORD_LEN];	//20 passowrd
...
public:
	...
	TCHAR			strid[MAX_EMAIL_LEN];	//字符串登陆				60
};
...
public:
	...
	TCHAR	nickname[MAX_USERNAME_LEN];	//用户名称
	TCHAR	company[MAX_COMPANY_LEN];	//公司名称
...
public:
	...
	TCHAR NameList[MAX_UPDATE_FRDLIST_NUM][MAX_USERNAME_LEN];
