...
//#include "../CommonClass/memalloc.h"

//#include "../WebChat/command.h"
//#include "../WebChat/defines.h"
//#include "../CommonClass/log.h"
//#include "commcom.h"
//#include "Pack.h"
#include <map>
#include <vector>
...
//	vector<pair<string,unsigned int> >  recvchatlist;  //chatid,客服  列表
...
public:
	...
	/*
	#define FLOATCHAT_ERROR_SUCCESS			0x00  //成功
	#define FLOATCHAT_ERROR_NOTINLIST		0x03  //用户不在recv用户列表
	#define FLOATCHAT_ERROR_USERNOTEXIST	0x04  //获取在线用户失败
	#define FLOATCHAT_ERROR_NORIGHT			0x05  //用户权限不足
	#define FLOATCHAT_ERROR_NOCHAT			0x06  //会话不存在
	#define FLOATCHAT_ERROR_PARAM			0x07  //参数无效
	#define FLOATCHAT_ERROR_ACCEPTBYOTHER	0x08  //会话已经被别人接受
	#define FLOATCHAT_ERROR_ADMIN           0x09  //管理员信息部正确
	#define FLOATCHAT_ERROR_TRANSREPEAT     0x0A  //当前处于会话转移状态，不能重复转移
	#define FLOATCHAT_ERROR_TRANSWEBREPEAT  0x0B  //跨站转移只能转移一次
	*/
